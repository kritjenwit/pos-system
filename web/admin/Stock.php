                ...
                <?php for ($i = 0; $i < count($response[0]); $i++) { ?>
                    <tr>
                        <form action="" method="POST">
                            <th><?php echo $i + 1 ?></th>
                            <th scope="col"><button class="btn btn-success" type="submit" name="product_id" value="<?php echo $response[0][$i]['product_id'] ?>">เพิ่ม stock</button>
                                <input class="w-25" type="number" name="inpnum" placeholder="ใส่จำนวน">
